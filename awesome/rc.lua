...
beautiful.init(os.getenv("HOME") .. "/dotfiles/awesome/theme.lua")
...
globalkeys =
    ...
    awful.key(
        ...
        "r",
        function()
            awful.spawn("rofi -combi-modi window,drun,ssh -show combi -icon-theme 'Papirus' -show-icons")
        end,
...
awful.spawn("pkill volumeicon")
for idx = 1, #startupPrograms, 1 do
    awful.spawn.with_shell(startupPrograms[idx])
end
