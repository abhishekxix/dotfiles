...
theme.taglist_fg_empty = colors.fg_inactive
...
theme.notification_border_color = colors.border_focus
theme.notification_broder_width = dpi(1)
...
theme.wallpaper = function()
    local path = os.getenv("HOME") .. "/.xwallpaper"
...
theme.awesome_icon = os.getenv("HOME") .. "/dotfiles/awesome/debianlogo.svg"
